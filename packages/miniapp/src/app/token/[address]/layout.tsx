...
export async function generateMetadata({
  ...
  // For embed, use landscape cover image (farcaster-farcaster-miniapp-cover.png)
  ...
  const embed = {
    ...
    button: {
      title: `Buy ${deployment.symbol}`,
      action: {
        type: 'launch_frame',
        name: 'Feydar',
        url: `${APP_URL}/token/${address}?buy=true`, // Include buy parameter to trigger buy button
